 ...
 */
public abstract class AbsAppCompatActivityID<V extends BaseMVPView, P extends BaseMVPPresenter<V>> extends AppCompatActivity implements PresenterProxyInterface<V, P> {

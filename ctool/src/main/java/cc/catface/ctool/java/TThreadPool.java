 ...
 * @desc: 线程池管理
 */
public final class TThreadPool {
    //线程池中最少的线程的数量
    private static final int CORE_POOL_SIZE = 2;  //最小为2个
    //线程池中最多的线程的数量
    ...
    //线程池中线程的执行的管理器
    public static final ExecutorService EXECUTOR = new ThreadPoolExecutor(CORE_POOL_SIZE, MAXIMUM_POOL_SIZE, KEEP_ALIVE, TimeUnit.SECONDS, mWorkQueue, mThreadFactory, new ThreadPoolExecutor.DiscardPolicy());

...
public class ContentListView extends ListView {
     ...
     */
    @Override public void setOnScrollListener(final OnScrollListener listener) {
    ...
    private class CompositeScrollListener implements OnScrollListener {
        private final List<OnScrollListener> scrollListenerList = new ArrayList<OnScrollListener>();

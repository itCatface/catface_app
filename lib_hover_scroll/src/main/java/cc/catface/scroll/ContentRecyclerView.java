...
public class ContentRecyclerView extends RecyclerView {
    ...
    private final ContentRecyclerView.CompositeScrollListener compositeScrollListener = new ContentRecyclerView.CompositeScrollListener();
    ...
    private class CompositeScrollListener extends OnScrollListener {
        private final List<RecyclerView.OnScrollListener> scrollListenerList = new ArrayList<RecyclerView.OnScrollListener>();

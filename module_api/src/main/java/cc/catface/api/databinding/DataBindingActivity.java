...
public class DataBindingActivity extends NormalActivity<ApiActivityDataBindingBinding> {
    ...
    private void title() {
        mBinding.tfa.setTitle(getIntent().getStringExtra(Const.AROUTER.DEFAULT_STRING_KEY)).setIcon1(R.string.fa_chevron_left).setIcon4("更新数据").setOnClickListener((TitleFontAwesome.OnClickListener) v -> {
    ...
    public void click(View view) {
        TToast.get(this).showBShortView("[普通处理]onClick=@{click}: " + System.currentTimeMillis(), TToast.B_SUCCESS);
    }
}

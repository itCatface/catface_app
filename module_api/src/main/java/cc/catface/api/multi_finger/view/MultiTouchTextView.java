 ...
 */
public class MultiTouchTextView extends TextView {
    public MultiTouchTextView(Context context) {
        super(context);
    }

    public MultiTouchTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public MultiTouchTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

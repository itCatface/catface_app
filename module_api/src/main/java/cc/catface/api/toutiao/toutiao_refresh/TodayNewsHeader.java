package cc.catface.api.toutiao.toutiao_refresh;
...
public class TodayNewsHeader extends LinearLayout implements RefreshHeader {
    ...
    private void initView(Context context) {
        ...
        LayoutParams lpNewRefresh = new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
//        lpNewRefresh.setMargins(30, dip2px(context,30), 30, 0);
        lpNewRefresh.setMargins(30, 30, 30, 0);

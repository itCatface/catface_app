package cc.catface.api.view.demo104_bezier.view;
...
public class ColorPicker extends View {
    ...
    private cc.catface.api.view.demo104_bezier.view.OnSeekColorListener onSeekColorListener;
    ...
    private void createColorWheel() {
        ...
        RadialGradient radialGradient = new RadialGradient(centerX, centerY, radius, 0xFFFFFFFF, 0x00FFFFFF, Shader.TileMode.CLAMP);
    ...
    public void setOnSeekColorListener(cc.catface.api.view.demo104_bezier.view.OnSeekColorListener listener) {

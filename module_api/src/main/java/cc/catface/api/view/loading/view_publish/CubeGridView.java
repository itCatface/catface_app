 ...
 * @desc 方块九宫格波浪
 */
public class CubeGridView extends FrameLayout {
    private Context mCtx;
    private int mDuration = 900;


    @RequiresApi(api = Build.VERSION_CODES.M) public CubeGridView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mCtx = context;
        post(() -> {
            init();
    ...
    @RequiresApi(api = Build.VERSION_CODES.M) private void init() {
        ...
        layoutParams.width = this.getWidth() / 3;
        layoutParams.height = this.getHeight() / 3;
    ...
    public void startAnim() {
        ObjectAnimator anim111 = ObjectAnimator.ofFloat(view11, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim112 = ObjectAnimator.ofFloat(view11, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim211 = ObjectAnimator.ofFloat(view21, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim212 = ObjectAnimator.ofFloat(view21, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim221 = ObjectAnimator.ofFloat(view22, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim222 = ObjectAnimator.ofFloat(view22, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim311 = ObjectAnimator.ofFloat(view31, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim312 = ObjectAnimator.ofFloat(view31, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim321 = ObjectAnimator.ofFloat(view32, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim322 = ObjectAnimator.ofFloat(view32, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim331 = ObjectAnimator.ofFloat(view33, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim332 = ObjectAnimator.ofFloat(view33, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim411 = ObjectAnimator.ofFloat(view41, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim412 = ObjectAnimator.ofFloat(view41, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim421 = ObjectAnimator.ofFloat(view42, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim422 = ObjectAnimator.ofFloat(view42, "scaleY", 1f, 0f, 1f);
        ObjectAnimator anim511 = ObjectAnimator.ofFloat(view51, "scaleX", 1f, 0f, 1f);
        ObjectAnimator anim512 = ObjectAnimator.ofFloat(view51, "scaleY", 1f, 0f, 1f);

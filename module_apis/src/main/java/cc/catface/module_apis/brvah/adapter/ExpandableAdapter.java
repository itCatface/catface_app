...
public class ExpandableAdapter extends BaseMultiItemQuickAdapter<MultiItemEntity, BaseViewHolder> {
    ...
    public ExpandableAdapter(List<MultiItemEntity> data) {
        super(data);
        addItemType(TYPE_LEVEL_0, R.layout.brvah_item_expandable_lv0);
        addItemType(TYPE_LEVEL_1, R.layout.brvah_item_expandable_lv1);
        addItemType(TYPE_PERSON, R.layout.brvah_item_expandable_lv2);
    }
        ...
        switch (holder.getItemViewType()) {
            case TYPE_LEVEL_0:
                switch (holder.getLayoutPosition() %
                        3) {
                    case 0:
                        holder.setImageResource(R.id.iv_head, R.mipmap.brvah_head_img0);
                        break;
                    case 1:
                        holder.setImageResource(R.id.iv_head, R.mipmap.brvah_head_img1);
                        break;
                    case 2:
                        holder.setImageResource(R.id.iv_head, R.mipmap.brvah_head_img2);
                        break;
                }

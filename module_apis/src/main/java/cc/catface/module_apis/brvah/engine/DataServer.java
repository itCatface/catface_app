...
public class DataServer {
    ...
    public static List<MySection> getSampleData() {
        ...
        list.add(new MySection(new Video(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
        list.add(new MySection(new Video(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
        list.add(new MySection(true, "Section 3", true));
        list.add(new MySection(new Video(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
        list.add(new MySection(new Video(HTTPS_AVATARS1_GITHUBUSERCONTENT_COM_LINK, CYM_CHAD)));
    ...
    public static List<NormalMultipleEntity> getNormalMultipleEntities() {
        ...
        for (int i = 0; i <= 4; i++) {
            ...
            list.add(new NormalMultipleEntity(NormalMultipleEntity.TEXT_IMG, CHAY_CHAN + i));
            list.add(new NormalMultipleEntity(NormalMultipleEntity.TEXT_IMG, CYM_CHAD + i));
            list.add(new NormalMultipleEntity(NormalMultipleEntity.TEXT_IMG, CHAY_CHAN + i));
        }
        return list;
    }

 ...
 */
@Route(path = Const.ARouter.apis_brvah) public class BRVAH_Activity extends LightAct<LightPresenter, BrvahActivityBrvahBinding> {
    ...
    private Fragment[] mFms = {new BRVAH_AnimationFm(), new BRVAH_MultiFm(), new BRVAH_MultiRVAdapterFm(), new BRVAH_HeadFootFm(), new BRVAH_PullToRefreshFm(), new BRVAH_SectionFm(), new BRVAH_EmptyViewFm(), new BRVAH_DragSwipeFm(), new BRVAH_ItemClickFm(), new BRVAH_ExpandableFm(), new BRVAH_DataBindingFm(), new BRVAH_UpFetchFm(), new BRVAH_SectionMultiFm()};

    private void popup(View view) {
        if (null == mPopup) {
            ListView lv = new ListView(this);
            lv.setBackgroundColor(Color.WHITE);
            String[] TITLE = {"Animation", "MultipleItem", "MultipleItem_RVAdapter", "Header/Footer", "PullToRefresh", "Section", "EmptyView", "DragAndSwipe", "ItemClick", "ExpandableItem", "DataBinding", "UpFetchData", "SectionMultipleItem"};

...
import cc.catface.module_apis.iflytek.speech.setting.TtsSettings;

public class IflytekTtsActivity extends Activity implements OnClickListener {
    private static String TAG = IflytekTtsActivity.class.getSimpleName();
    // 语音合成对象
    ...
    @SuppressLint("ShowToast") public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apis_iflytek_activity_tts);
        initLayout();
    ...
    private void initLayout() {
        ...
        mRadioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            ...
            @Override public void onCheckedChanged(RadioGroup group, int checkedId) {
                if (R.id.tts_radioCloud == checkedId) mEngineType = SpeechConstant.TYPE_CLOUD;
                else if (R.id.tts_radioLocal == checkedId) {
                    mEngineType = SpeechConstant.TYPE_LOCAL;
                    //启动本地引擎
                    //					String path = ResourceUtil.TTS_RES_PATH+"="+ ResourceLoader.getResPath(IflytekTtsActivity.this,mSharedPreferences,"tts")+","+ResourceUtil.ENGINE_START+"=tts";
    ...
    @Override public void onClick(View view) {
        ...
        if (R.id.image_tts_set == view.getId()) {
            Intent intent = new Intent(IflytekTtsActivity.this, TtsSettings.class);
            startActivity(intent);
            // 开始合成
            // 收到onCompleted 回调时，合成结束、生成合成音频
            // 合成的音频格式：只支持pcm格式
        } else if (R.id.tts_play == view.getId()) {
            ...
            // 取消合成
        } else if (R.id.tts_cancel == view.getId()) {
            mTts.stopSpeaking();
            // 暂停播放
        } else if (R.id.tts_pause == view.getId()) {
            mTts.pauseSpeaking();
            // 继续播放
        } else if (R.id.tts_resume == view.getId()) {
            mTts.resumeSpeaking();
            // 选择发音人
        } else if (R.id.tts_btn_person_select == view.getId()) {
    ...
    private void showPresonSelectDialog() {
        if (R.id.tts_radioCloud == mRadioGroup.getCheckedRadioButtonId()) {
            ...
            // 选择本地合成
        } else if (R.id.tts_radioLocal == mRadioGroup.getCheckedRadioButtonId()) {
            new AlertDialog.Builder(this).setTitle("本地合成发音人选项").setSingleChoiceItems(localVoicersEntries, // 单选框有几项,各是什么名字
    ...
    private SynthesizerListener mTtsListener = new SynthesizerListener() {
        ...
        @Override public void onSpeakProgress(int percent, int beginPos, int endPos) {
            ...
            if (!"henry".equals(voicerCloud) || !"xiaoyan".equals(voicerCloud) || !"xiaoyu".equals(voicerCloud) || !"catherine".equals(voicerCloud)) endPos++;
    ...
    private String getResourcePath() {
        ...
        tempBuffer.append(";");
        //发音人资源
        tempBuffer.append(ResourceUtil.generateResourcePath(this, RESOURCE_TYPE.assets, "tts/" + IflytekTtsActivity.voicerLocal + ".jet"));

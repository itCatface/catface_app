...
import cc.catface.iflytek.iflytek.speech.setting.IatSettings;
import cc.catface.iflytek.iflytek.speech.util.FucUtil;
import cc.catface.iflytek.iflytek.speech.util.JsonParser;

public class IflytekIatActivity extends Activity implements OnClickListener {
    private static String TAG = "IflytekIatActivity";
    // 语音听写对象
    ...
    @SuppressLint("ShowToast") public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.apis_iflytek_activity_iat);
        initLayout();
        // 初始化识别无UI识别对象

...
public class Mail extends Authenticator {
    ...
    public Mail() {
        _host = "mail.iflytek.com"; // default smtp server
        _port = "993"; // default smtp port
        _sport = "993"; // default socketfactory port
        ...
        _multipart =
                new MimeMultipart();      // There is something wrong with
        // MailCap, javamail can not find a handler for the multipart/mixed
        // part, so this bit needs to be added.
        MailcapCommandMap mc =
                (MailcapCommandMap) CommandMap.getDefaultCommandMap();
        mc.addMailcap("text/html;; x-java-content-handler=com.sun.mail" +
                ".handlers.text_html");
        mc.addMailcap("text/xml;; x-java-content-handler=com.sun.mail.handlers" +
                ".text_xml");
        mc.addMailcap("text/plain;; x-java-content-handler=com.sun.mail" +
                ".handlers.text_plain");
        mc.addMailcap("multipart/*;; x-java-content-handler=com.sun.mail" +
                ".handlers.multipart_mixed");
        mc.addMailcap("message/rfc822;; x-java-content-handler=com.sun.mail" +
                ".handlers.message_rfc822");
...
*/
        ...
        props.put("mail.smtp.host", "mail.iflytek.com");

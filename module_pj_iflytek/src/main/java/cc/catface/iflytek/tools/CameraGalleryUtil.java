package cc.catface.iflytek.tools;
...
public class CameraGalleryUtil {
    ...
    public static final Uri fileUri = Uri.fromFile(new File(Environment.getExternalStorageDirectory().getPath() + File.separator + "temp.jpg"));    // 临时储存的Uri

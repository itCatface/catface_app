...
import cc.catface.showapi.databinding.ShowapiActivityJokeBinding;

public class JokeActivity extends LightAct<LightPresenter, ShowapiActivityJokeBinding> {

    @Override public int layoutId() {
        return R.layout.showapi_activity_joke;
    }

...
import cc.catface.showapi.joke.engine.adapter.YYJoke341_3Adapter;
import cc.catface.showapi.joke.engine.domain.YYJoke341_3;
...
public class YYJoke341_3Fm extends LightFm<YYJoke341_3PresenterImp, ShowapiFmYyJoke3413Binding> implements YYJoke341_3VP.YYJoke341_3View {
    ...
    @Override public void initData() {
        ...
        RetrofitT.getInstance().post(ShowapiConst.url_yy_joke_341_3, map, new RetrofitCallback() {

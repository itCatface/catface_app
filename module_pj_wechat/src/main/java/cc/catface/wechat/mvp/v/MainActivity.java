...
import cc.catface.wechat.mvp.p.MainPresenterImpl;
import cc.catface.wechat.mvp.p.MainVP;
import cc.catface.wechat.utils.ShadeView;

/**
 * Created by catfaceWYH --> tel|wechat|qq 130 128 92925
 */
@Route(path = Const.ARouter.pj_wechat_main) @CreatePresenter(MainPresenterImpl.class) public class MainActivity extends MvpActivity<MainVP.MainView, MainPresenterImpl, WechatActivityMainBinding> implements MainVP.MainView, View.OnClickListener {

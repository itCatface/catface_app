package cc.catface.start.welcome.view;
...
import cc.catface.start.welcome.vp.WelcomePresenterImp;
import cc.catface.start.welcome.vp.WelcomeVP;

/**
 * Created by catfaceWYH --> tel|wechat|qq 130 128 92925
 */
@Route(path = Const.ARouter.start_welcome) public class WelcomeActivity extends LightAct<WelcomePresenterImp, StartActivityWelcomeBinding> implements WelcomeVP.WelcomeView {
    ...
    private void openPop(View v) {
        ...
        TBG.setBackgroundAlpha(this, 0.5f);
        mPop.setOnDismissListener(() -> TBG.setBackgroundAlpha(this, 1f));
